...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/updateCustomerServlet" method="post">
        ...
        <div class="form-group">
            ...
            <select name="address" id="address" class="form-control" >
                <c:forEach items="${cities}" var="city">
                    <c:if test="${customer.address == city.name}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="qq" class="form-control" name="qq" value="${customer.qq}" placeholder="请输入QQ号码"/>
        </div>

        <div class="form-group">
            <label for="email">Email：</label>
            <input type="text" id="email" class="form-control" name="email" value="${customer.email}" placeholder="请输入邮箱地址"/>
        </div>

        <div class="form-group" style="text-align: center">
            <input class="btn btn-primary" type="submit" value="提交" />
            <input class="btn btn-default" type="reset" value="重置" />
            <a href="${pageContext.request.contextPath}/customerListByPageServlet"><input class="btn btn-default" type="button" value="返回"/></a>
        </div>
    </form>
</div>
</body>
